...
void belokcepat()  /*------------Tes Berhenti---Hasil OK----Tikung bisa, tapi blom bisa balik, muter terus------*/
{
   ...
   delay(50);
      ...
      // ini dibikin supaya, pas udah lewat dari garis, dia belok kiri
      // kemudia kalau sudah ketemu garis lagi dia follow garis lagi
      while(positionVal ==  255  && (sensorgaris_pinggir == 0b1100 || sensorgaris_pinggir == 0b1000 || sensorgaris_pinggir == 0b0100)) {
        PIDLeft = 0;
        PIDRight = gas * 0.5;
