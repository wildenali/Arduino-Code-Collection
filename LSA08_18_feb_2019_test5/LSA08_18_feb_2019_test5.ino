...
void belokcepat()  /*------------Tes Berhenti---Hasil OK----Tikung bisa, tapi blom bisa balik, muter terus------*/
{
   ...
   delay(50);
      ...
      // ini dibikin supaya, pas udah lewat dari garis, dia belok kanan
      // kemudia kalau sudah ketemu garis lagi dia follow garis lagi
      while(positionVal ==  255  && (sensorgaris_pinggir == 0b0011 || sensorgaris_pinggir == 0b0001 || sensorgaris_pinggir == 0b0010)) {
        PIDLeft = gas * 0.5;
        PIDRight = 0;
